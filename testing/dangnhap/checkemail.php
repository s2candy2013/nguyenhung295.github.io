...
if (isset($_POST["btn_submit"])) {
    ...
    if ($check_email->rowCount() == 0) {
        ...
        $mail->SMTPAuth   = true;
        $mail->Username   = 'huyhung29599@gmail.com';
        $mail->Password   = 'hung2951999';
        $mail->SMTPSecure = 'tls';
        $mail->Port       = 587;
        
        // người nhận
        $mail->CharSet = 'UTF-8';
        $mail->setFrom('huyhung29599@gmail.com', 'Hưng from SofaTeam');
        $mail->addAddress("$email");
        $mail->addReplyTo('huyhung29599@gmail.com');
